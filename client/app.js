...
//
//     console.log("User submitted their query");
//     var sqft = document.getElementById("uiSqft");
//     var bhk = getBHKValue();
//     var bathroom = getBathValue();
//     var location = document.getElementsByName("chooseLocation");
...
function onClickGetPrice() {
  ...
  var url = "http://127.0.0.1:5000/get_prediction"; //Use this if you are NOT using nginx which is first 7 tutorials
